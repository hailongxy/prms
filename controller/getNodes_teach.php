...
include '../config.php';
$sql = mysqli_query($con,"SELECT * FROM teach where parent_id = '".$pId."' and userid = '".$_SESSION['userid']."'");

while($row = mysqli_fetch_array($sql)){
	
	$sub_sql = mysqli_query($con,"SELECT * FROM teach where parent_id = '".$row['id']."' and userid = '".$_SESSION['userid']."'");

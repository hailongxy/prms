<?php	
include '../config.php';
if($_GET['act'] == 'get_topic_data'){
	$topicid = $_POST['topicid'];
	$result = mysqli_query($con,"SELECT * FROM special_topic where topicid = '".$topicid."' and userid = '".$_SESSION['userid']."' order by createtime asc");
	$get_data = array();
	$temp_array = array();
	$result_array = array();
	...
	foreach($result_array as $result_value){
		...
		$temp_array[strtotime($time_formate.' 00:00:00').'000']++;
	}

	...
	<?php
	setcookie( "TestCookie",  "okol",  time() + 3600,  "/", "prams.hailongxy.cn", 1 );
	?>
...
<form action="#" class="form-horizontal">
				...
				<div class="control-group">
                                                ...
                                                <div class="control-group">
													...
													<label class="control-label" style="width:70px">数目：</label>

													<div class="controls" style="margin-left:80px">

														<input type="text" placeholder="" class="m-wrap medium" id="add_amount">
				...
				<div class="control-group">
                                                ...
                                                <div class="control-group">
													...
													<div class="controls" style="margin-left:80px">
														...
														<input type="text" placeholder="" class="m-wrap medium" id="update_amount">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							资金管理 <small></small>
							<button type="button" class="btn green" style="float:right; margin-right:10px;" data-toggle="modal" data-target="#add_modal">新增资金</button>
						</h3>
...
$sql = "SELECT COUNT(*) FROM cash where userid = '".$_SESSION['userid']."'  order by id desc";
$row = mysqli_fetch_array( mysqli_query($con,$sql) );
$count = $row[0];

$last_page = (int)($count/10)+1;

$result = mysqli_query($con,"SELECT * FROM cash where userid = '".$_SESSION['userid']."'  order by id desc limit ".$start_item.",10");
...
<table class="table table-bordered table-hover">
									...
									<?php	while($row = mysqli_fetch_array($result)){	?>
										<tr>
											...
											<td><a href="javascript:;" onClick="delete_cash(<?php	echo $row['id'];	?>);">删除</a></td>
...
<div class="pagination pagination-centered">
									...
									<ul>
										...
										<li><a href="index.php?page=<?php	echo	$last_page;	?>">末页</a></li>
										<?php	}	?>
									</ul>
...
<script type="application/javascript">
    $("#add_save").click(function(){//输出选中的值
		...
		$.ajax({
			url:'controller/c_index.php?act=add_save',
			data:{'add_name':add_name,'add_amount':add_amount,'add_content':add_content},
			type:'post',
	...
	function pre_update(update_id){
		...
		//alert(id);
		$.ajax({
			url:'controller/c_index.php?act=pre_update',
			data:{'id':id},
			type:'post',
			success:function(msg){
				//alert(msg);
    ...
    $("#update_save").click(function(){//输出选中的值
		...
		$.ajax({
			url:'controller/c_index.php?act=update_save',
			data:{'id':id,'update_name':update_name,'update_amount':update_amount,'update_content':update_content},
			type:'post',
			success:function(msg){
				//alert(msg);
				if(msg == 1){
	...
	function delete_cash(delete_id){
		id = delete_id;
		//alert(id);
		$.ajax({
			url:'controller/c_index.php?act=delete',
			data:{'id':id},
			type:'post',
			success:function(msg){
				if(msg == 1){

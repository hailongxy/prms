var Inbox = function () {
    ...
    var content = $('.inbox-content');	//内容
    var loading = $('.inbox-loading');	//加载
    ...
    var loadMessage = function (name, resetMenu) {	//加载信息
    ...
    var initFileupload = function () {	//初始化文件上传

        $('#fileupload').fileupload({
            // Uncomment the following to send cross-domain cookies:
            //xhrFields: {withCredentials: true},
            url: 'upload1/server/php/',	//上传位置

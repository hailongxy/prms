    ...
    <?php
    if($_GET['type'] == 'edit'){
        $sql = mysqli_query($con,"SELECT * FROM mind_map WHERE id ='".$_GET['id']."' and userid = '".$_SESSION['userid']."'");
...
<script>
    ...
    function add() {
        ...
        $.ajax({
            url:'controller/c_mind_map_manage.php?act=add_save&select_title=<?php	echo	$select_title;		?>',
    ...
    function update() {
        ...
        var content = mind.getAllDataString();
        $.ajax({
            url:'controller/c_mind_map_manage.php?act=update_save&select_title=<?php	echo	$select_title;		?>',

				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							知识管理
                            <button type="button" class="btn green" style="float:right; margin-right:10px;" onClick="add_top_knowledge();">新增一级知识</button>
						</h3>
					...
					<div class="span6">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-comments"></i>知识列表</div>
							</div>
...
<div class="control-group">
				...
				<div class="control-group">
                                                ...
                                                <div class="control-group">
													...
													<label class="control-label" style="width:80px">掌握程度：</label>
...
<?php	include 'footer.php';	?>
	...
	<SCRIPT type="text/javascript">
		...
		function zTreeOnDrop(event, treeId, treeNodes, targetNode, moveType) {
			...
			//alert(parent_id);
			$.ajax({
				url:'controller/c_knowledge.php?act=update_parent_id_save',
		...
		function zTreeOnClick(event, treeId, treeNode) {
			id = treeNode.id;
			$.ajax({
				url:'controller/c_knowledge.php?act=pre_update',
				data:{'id':id},
				type:'post',
				success:function(msg){
					var obj = eval('('+msg+')');
		...
		function beforeRemove(treeId, treeNode) {	//开始删除
			...
			//alert(id);
			$.ajax({
				url:'controller/c_knowledge.php?act=delete',
				data:{'id':id},
				type:'post',
				success:function(msg){
					if(msg == 1){
		...
		function beforeRename(treeId, treeNode, newName) {	//开始重命名
			...
			if (newName.length == 0) {
				...
				name = nameArray[0];
				$.ajax({
					url:'controller/c_knowledge.php?act=update_name_save',
		...
		function addHoverDom(treeId, treeNode) {	//添加滑动DOM
			...
			if (btn) btn.bind("click", function(){
				...
				$.ajax({
					url:'controller/c_knowledge.php?act=add_save',
    ...
    $("#update_save").click(function(){//输出选中的值
		...
		$.ajax({
			url:'controller/c_knowledge.php?act=update_save',
	...
	function add_top_knowledge(){	//新增一级分类
		$.ajax({
			url:'controller/c_knowledge.php?act=add_top_save',
			data:{},
			type:'post',
			success:function(msg){
				if(msg == 1){

...
<div style="color:#FFF;font-size: x-large;">
	...
	<div class="content">
		...
		<form class="form-vertical login-form" action="index.html">
			...
			<h3 class="form-title" style="font-weight:bold">注册</h3>
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="text" id="username" name="username" style="background-color: wheat;"/>
            ...
            <div class="control-group">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="text" id="email" name="email" style="background-color: wheat;"/>
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="password" name="password" id="password"  style="background-color: wheat;"/>
...
<div class="control-group">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="password" name="confirm_password" id="confirm_password"  style="background-color: wheat;"/>

				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							项目管理
                            <button type="button" class="btn green" style="float:right; margin-right:10px;" onClick="add_top_project();">新增一级项目</button>
						</h3>
					...
					<div class="span6">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-comments"></i>项目列表</div>
							</div>
...
<div class="control-group">
				...
				<div class="control-group">
                                                ...
                                                <div class="control-group">
													...
													<label class="control-label" style="width:80px">进度：</label>
...
<?php	include 'footer.php';	?>
	...
	<SCRIPT type="text/javascript">
		...
		var setting = {
			async: {	//异步
				enable: true,
				url:"controller/getNodes_project.php",
		...
		function zTreeOnDrop(event, treeId, treeNodes, targetNode, moveType) {
			...
			//alert(parent_id);
			$.ajax({
				url:'controller/c_project.php?act=update_parent_id_save',
		...
		function zTreeOnClick(event, treeId, treeNode) {
			id = treeNode.id;
			$.ajax({
				url:'controller/c_project.php?act=pre_update',
				data:{'id':id},
				type:'post',
				success:function(msg){
					var obj = eval('('+msg+')');
		...
		function beforeRemove(treeId, treeNode) {	//开始删除
			...
			//alert(id);
			$.ajax({
				url:'controller/c_project.php?act=delete',
				data:{'id':id},
				type:'post',
				success:function(msg){
					if(msg == 1){
		...
		function beforeRename(treeId, treeNode, newName) {	//开始重命名
			...
			if (newName.length == 0) {
				...
				name = nameArray[0];
				$.ajax({
					url:'controller/c_project.php?act=update_name_save',
		...
		function addHoverDom(treeId, treeNode) {	//添加滑动DOM
			...
			if (btn) btn.bind("click", function(){
				...
				$.ajax({
					url:'controller/c_project.php?act=add_save',
    ...
    $("#update_save").click(function(){//输出选中的值
		...
		$.ajax({
			url:'controller/c_project.php?act=update_save',
	...
	function add_top_project(){	//新增一级项目
		$.ajax({
			url:'controller/c_project.php?act=add_top_save',
			data:{},
			type:'post',
			success:function(msg){
				if(msg == 1){
